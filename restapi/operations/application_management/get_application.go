...
/*GetApplication swagger:route GET /runtimeEnvironments/{providerIdRE}/applications/{providerIdAI} Application management getApplication

Get RuntimeAppInstance
