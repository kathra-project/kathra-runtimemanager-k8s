...
// DeleteApplicationParams contains all the bound params for the delete application operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteApplication
...
//
// To ensure default values, the struct must have been initialized with NewDeleteApplicationParams() beforehand.
func (o *DeleteApplicationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteApplicationParams) bindProviderIDAI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteApplicationParams) bindProviderIDRE(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
